...
foreach $st_line (@st ) {
       ...
       #print "line[0]: $line[0] line[1]: $line[1] line[2]: $line[2] line[3]: $line[3] line[4]: $line[4] line[5]: $line[5] line[6]: $line[6]  line[7]: $line[7]  \n";
          ...
          if (uc($line[0]) =~ /LIN/) {
             ...
             if ($line[14] eq "CH") {
                $cntry_of_cast = $line[15]
             };
#             print "Inside LIN. line[14]: $line[14]  line[15]: $line[15]  cntry_of_cast: $cntry_of_cast   \n";
          };
          ...
          #Alex Gerlants. 07/05/2022. 1603_Novelis_Country_Of_Smelt. Begin
          if ( uc($line[0]) eq "LIN" && uc($line[20]) eq "F6" ) {
             $primary_cntry_of_smelt = $line[21];
             print "primary_cntry_of_smelt: $primary_cntry_of_smelt  \n";
          };


          if ( uc($line[0]) eq "LIN" && uc($line[22]) eq "S2" ) {
             $secondary_cntry_of_smelt = $line[23];
             print "secondary_cntry_of_smelt: $secondary_cntry_of_smelt  \n";
          };
          #Alex Gerlants. 07/05/2022. 1603_Novelis_Country_Of_Smelt. End
...
#print ("Before IF. tty_f_mea1[3]: $tty_f_mea1[3]  tty_f_mea2[3]: $tty_f_mea2[3]  tty_b_mea1[3]: $tty_b_mea1[3]  tty_b_mea2[3]: $tty_b_mea2[3]   \n");

if (length($bkn_f_mea2[3]) == 0 && length($bkn_b_mea2[3]) == 0 && length($x27_f_mea2[3]) == 0 && length($x27_b_mea2[3]) == 0 && length($ult_f_mea2[3]) == 0 && length($ult_b_mea2[3]) == 0 && length($ysr_f_mea2[3]) == 0 && length($ysr_b_mea2[3]) == 0 && length($upt_f_mea2[3]) == 0 && length($upt_b_mea2[3]) == 0 && length($isu_f_mea2[3]) == 0 && length($isu_b_mea2[3]) == 0 && length($tet_f_mea2[3]) == 0 && length($tet_b_mea2[3]) == 0 && length($dpa_f_mea2[3]) == 0 && length($dpa_b_mea2[3]) == 0 && length($tnt_f_mea2[3]) == 0 && length($tnt_b_mea2[3]) == 0 && length($ypn_f_mea2[3]) == 0 && length($ypn_b_mea2[3]) == 0 && length($itt_f_mea2[3]) == 0 && length($itt_b_mea2[3]) == 0 && length($mdo_f_mea2[3]) == 0 && length($mdo_b_mea2[3]) == 0 && length($ttt_f_mea2[3]) == 0 && length($ttt_b_mea2[3]) == 0 && length($aro_f_mea2[3]) == 0 && length($aro_b_mea2[3]) == 0 && length($n4t_f_mea2[3]) == 0 && length($n4t_b_mea2[3]) == 0 && length($ttl_f_mea2[3]) == 0 && length($ttl_b_mea2[3]) == 0 && length($trt_f_mea2[3]) == 0 && length($trt_b_mea2[3]) == 0 && length($zsi) == 0 && length($zfe) == 0 && length($zcu) == 0 && length($zmn) == 0 && length($zmg) == 0 && length($zcr) == 0 && length($zni) == 0 && length($zzn) == 0 && length($zti) == 0 && length($zgh) == 0 && length($zal) == 0 && length($bb) == 0 && length($v) == 0 && length($zb) == 0 && length($zca) == 0 && length($zcd) == 0 && length($lb) == 0 && length($sx) == 0 && length($zpb) == 0 && length($zsb) == 0 && length($zsn) == 0 && length($zzr) == 0) {
   print ("tty_f_mea1[3]: $tty_f_mea1[3] tty_f_mea2: $tty_f_mea2 \n"); 


      # $from = 'ALBL_863_Processing'; #Alex Gerlants. 01/27/2024. Comment out
      $from = 'reports@albl.com'; #Alex Gerlants. 01/27/2024
      #$to = 'agerlants@albl.com';
      $subject = '863 rejection notice for Customer Coil ' . $lin[9];
      $message = "863 for Customer Coil " . $lin[9] . " failed to process due to all mechanical and chemical test results missing.\nPlease resend corrected 863 \n\n\n";

      $query = "select email_address from auto_report_emails where report_name = 'rejected 863' order by email_address desc";
      my $addr = "";
...
#-----------------------------------------------------------------------------------
$dbh->do(" INSERT INTO dbo.data_in_863_rejected (    EDI_FILE_ID,
                                                coil_num,
                                                WD,
                                                TH,
                                                TWO,
                                                ...
                                                date_time_received,
                                                cntry_of_cast,
                                                primary_cntry_of_smelt,
                                                secondary_cntry_of_smelt
                                                )
                                         VALUES ( $file_id,
                                                '$lin[9]',
                                                '$width',
...
#print ("Before commit and after INSERT INTO data_in_863_rejected \n");
...
} # if (length($bkn_f_mea2[3]) == 0 && ...

#Update data_in_863 table

#print ("Before INSERT INTO data_in_863. file_id: $file_id  Coil: $lin[9]  cntry_of_cast: $cntry_of_cast  lin[14]: $lin[14]  lin[15]: $lin[15]   \n");
...
$cntry_of_cast = (); #Alex Gerlants. 04/19/2021
$lin[15] = (); #Alex Gerlants. 04/19/2021
$lin[9] = ();
$mea3[3] = ();
$mea4[3] = ();
$two_mea[3] = ();
...
if ( $skid_count == 0 ) {
    ...
    #my $coil_org2 = $coil_org_num;
    my $string_test; #Alex Gerlants. 05/29/2024
	...
	#--------------------------------------------------------------------------------------------------
        ...
        if ($skid_sheet_status eq 16) {
            ...
            #Alex Gerlants. 03/03/2021. 1120_Skid Hold-For-Cert status. End
                ...
                $string_test = $string_test . "," . $sheet_skid_num; #Alex Gerlants. 05/29/2024
                print "string_test: $string_test  \n"; #Alex Gerlants. 05/29/2024
    ...
    # $from = '863_Received'; #Alex Gerlants. 01/27/2024. Comment out
    $from = 'reports@albl.com'; #Alex Gerlants. 01/27/2024
...
=cut
    ...
    if (length($string_test) gt 0) { #Alex Gerlants. 05/29/2024
       while (  $addr = $dth->fetchrow() ) {
           # print "addr: $addr   \n";
           # $to = $addr;
...
if ($ok_997 eq "yes") {
   ...
   if ( $skid_count == 0 ) {
      # $from = '863_3_db.pl'; #Alex Gerlants. 01/27/2024. Comment out
      $from = 'reports@albl.com'; #Alex Gerlants. 01/27/2024
      $to = 'agerlants@albl.com';
