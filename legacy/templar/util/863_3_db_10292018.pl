...
#print ("Before INSERT INTO data_in_863. file_id: $file_id lin[9]: $lin[9] \n");
...
if ($ok_997 eq "yes") {
   ...
   $subject = 'EDI 863 received. 997 created.';
   $message = "EDI 863 file '" . $edi_file . "' received  successfully. " . "997 for file '" . $edi_file . "' created succsessfully.";
