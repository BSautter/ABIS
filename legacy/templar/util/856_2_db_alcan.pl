...
# 02/15/2010 Tony Q revision 1
#File Location
$INCOMING_856_X12	= ".\incoming_856_x12";
...
#open(MAIL, "/usr/bin/mailx -s 'Constellium EDI 856 received', 'jqni\@albl\.com' < $INCOMING_COIL_856_X12/$X12_file|");
#close(MAIL);
