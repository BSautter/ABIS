...
sftp -b ./GXS_VAN_IN_MOVE_2PROD.ksh $LOGINID@sftp.gateway.inovisworks.net # sFTP all available files from VAN
...
exit $ret_code_out  # Return code of the script is the same as the return code of the outbound sftp.
