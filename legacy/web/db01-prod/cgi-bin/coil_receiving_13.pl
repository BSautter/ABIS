...
<body>
    <p>
        <FORM id="coil_input" ACTION="coil_receiving_13.pl" METHOD="post">
...
ENDOFTEXT
                ...
                print <<ENDOFTEXT;
        <FORM id="coil_org_num" ACTION="coil_receiving_13.pl" METHOD="post">
                        </p>
                        <P>
ENDOFTEXT
...
ENDOFTEXT
                print <<ENDOFTEXT;
        <FORM id="coil_abc_num" ACTION="coil_receiving_13.pl" METHOD="post">
                        </p>
                        <P>
ENDOFTEXT
...
print <<ENDOFTEXT;
                        ...
                        <FORM ACTION="coil_receiving_13.pl" METHOD="post">
