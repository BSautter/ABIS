...
<body>
    <p>
        <FORM id="coil_input" ACTION="coil_receiving_65.pl" METHOD="post">
...
ENDOFTEXT
		...
		print <<ENDOFTEXT;
        <FORM id="coil_org_num" ACTION="coil_receiving_65.pl" METHOD="post">
 		 	</p>
		 	<P>
ENDOFTEXT
...
print <<ENDOFTEXT;
		 	...
		 	<P>
		 		<INPUT TYPE="submit" VALUE="New Coil ABC Num" disabled>
		 	</p>
 		</FORM>
 		<p> or </p> 		 		
ENDOFTEXT
		print <<ENDOFTEXT;
        <FORM id="coil_abc_num" ACTION="coil_receiving_65.pl" METHOD="post">
 		 	</p>
		 	<P>
ENDOFTEXT
...
print <<ENDOFTEXT;
		<FORM ACTION="coil_receiving_65.pl" METHOD="post"> 		
