...
$db       = "dbi:Oracle:host=db01.albl.com;sid=abc11;port=1523";
#$db       = "dbi:Oracle:host=db01.albl.com;sid=abc01";
$username = "dbo";
$passwd   = "__DB_PASSWORD_REDACTED__";
$cgi = new CGI;
$Printer_Add = '192.168.10.64';
...
<body>
    <p>
        <FORM id="coil_input" ACTION="coil_receiving_64.pl" METHOD="post">
...
ENDOFTEXT
		...
		print <<ENDOFTEXT;
        <FORM id="coil_org_num" ACTION="coil_receiving_64.pl" METHOD="post">
 		 	</p>
		 	<P>
ENDOFTEXT
...
ENDOFTEXT
		print <<ENDOFTEXT;
        <FORM id="coil_abc_num" ACTION="coil_receiving_64.pl" METHOD="post">
 		 	</p>
		 	<P>
ENDOFTEXT
...
print <<ENDOFTEXT;
		<FORM ACTION="coil_receiving_64.pl" METHOD="post"> 		
