...
$db       = "dbi:Oracle:host=db02new;sid=abc11; port=1523";
$username = "dbo";
...
ENDOFTEXT
                ...
                print <<ENDOFTEXT;
        <FORM id="coil_org_num" ACTION="coil_receiving.pl" METHOD="post">
                        </p>
                        <P>
ENDOFTEXT
...
ENDOFTEXT
                print <<ENDOFTEXT;
        <FORM id="coil_abc_num" ACTION="coil_receiving.pl" METHOD="post">
                        </p>
                        <P>
ENDOFTEXT
...
#				my $Printer_Socket = IO::Socket::INET ->new(
#										Proto   =>'tcp',
#										PeerPort=>"6101",
#										ReuseAddr=>0,
#										Timeout  =>2,
#										) or myExit("Cannot connect to printer: $!");
                ...
                for ( $count = 2 ; $count >= 1 ; $count-- ) {
					my $line = '';
					#$line ="^XA~TA000~JSN^LT0^MNW^MTD^PON^PMN^LH0,0^JMA^PR4,4~SD15^JUS^LRN^CI0^XZ";
					$line .="^XA";
					$line .="^MMT";
					#$line .="^PW384";
					#$line .="^LL0203";
					$line .="^LS0";
					$line .="^BY3,3,38^FT365,78^BCI,,N,N";
					$line .="^FD>;210881^FS";
					$line .="^FT375,150^A0I,25,33^FH\^FDCoil AbBC #:^FS";
					$line .="^FO69,20^GB138,0,5^FS";
					$line .="^FT376,25^A0I,20,26^FH\^FDINSPECTED BY:^FS";
					#$line .="^PQ1,0,1,Y";
					$line .="^XZ";
					
#						print $Printer_Socket "CT~~CD,~CC^~CT~";
#						print $Printer_Socket "^XA~TA000~JSN^LT0^MNW^MTD^PON^PMN^LH0,0^JMA^PR4,4~SD15^JUS^LRN^CI0^XZ";
#						print $Printer_Socket "^XA";
#						print $Printer_Socket "^MMT";
#						print $Printer_Socket "^PW384";
#						print $Printer_Socket "^LL0203";
#						print $Printer_Socket "^LS0";
#						print $Printer_Socket "^BY3,3,38^FT365,78^BCI,,N,N";
#						print $Printer_Socket "^FD>;210881^FS";
#						print $Printer_Socket "^FT375,150^A0I,25,33^FH\^FDCoil ABC #:^FS";
#						print $Printer_Socket "^FO69,20^GB138,0,5^FS";
#						print $Printer_Socket "^FT376,25^A0I,20,26^FH\^FDINSPECTED BY:^FS";
#						print $Printer_Socket "^PQ1,0,1,Y";
#						print $Printer_Socket "^XZ";
#						print $Printer_Socket "! 0 200 200 240 1";
#						print $Printer_Socket "TEXT 4 0 30 40 Hello World";
...
#						print $Printer_Socket "PRINT";
						...
						#print $Printer_Socket "Line 1\n";
						#print $Printer_Socket "Line 2\n";
						#print $Printer_Socket "Line 3\n";
						#print $Printer_Socket "Line 4\n";
						#print $Printer_Socket "Line 5\n";
						#print $Printer_Socket "Line 6\n";
...
sub print_label_for_coil_abc_num ($){
        ...
        for ( $count = 2 ; $count >= 1 ; $count-- ) {
						...
						print $Printer_Socket "Line a\n";
						print $Printer_Socket "Line b\n";
						print $Printer_Socket "Line c\n";
						print $Printer_Socket "Line d\n";
						print $Printer_Socket "Line e\n";
						print $Printer_Socket "Line f\n";
