...
elsif ( param('print_no_coil_barcode_label') ) {
	&print_no_coil_barcode_label();	#print no coil barcod label	
}

elsif ( param('print_bundle_label_for_coil_abc_num') ) {
	$print_bundle_label_for_coil_abc_num_data = param('print_bundle_label_for_coil_abc_num');
	&print_bundle_label_for_coil_abc_num($print_bundle_label_for_coil_abc_num_data);	#print bundle of coil ABC coil lables	
}
...
sub print_label_for_coil_abc_num ($){
	...
	for ( $count = 2 ; $count >= 1 ; $count-- ) {
		...
		print $Printer_Socket "PAGE-WIDTH 380\n";
		print $Printer_Socket "BAR-SENSE\n";
		print $Printer_Socket "T Ari12pt.cpf 0 32 20 NO COIL BARCODE\n";
		print $Printer_Socket "B 39 2 1 50 16 73 S" . $coil_abc_num."\n";
		print $Printer_Socket "FORM\n";
		print $Printer_Socket "PRINT\n";		
	}
	close($Printer_Socket);
...
sub print_no_coil_barcode_label {
	my $coil_abc_num = "000000";
...
sub print_bundle_label_for_coil_abc_num ($){
	my $coil_abc_num = $_[0];
	my $bundle_num = 50;
	...
	for ($coil_count = $bundle_num ; $coil_count >=1 ; $coil_count-- ) {
		...
		for ( $count = 2 ; $count >= 1 ; $count-- ) {
			...
			print $Printer_Socket "PAGE-WIDTH 380\n";
			print $Printer_Socket "BAR-SENSE\n";
			print $Printer_Socket "T 0 5 32 20 COIL ABC #:  ". $coil_abc_num."\n";
			print $Printer_Socket "B 39 2 1 50 6 73 S" . $coil_abc_num."\n";
			print $Printer_Socket "T 7 1 21 145 INSPECTED BY:___________\n";
			print $Printer_Socket "FORM\n";
			print $Printer_Socket "PRINT\n";		
		}
		$coil_abc_num++;
