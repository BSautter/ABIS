...
<head>
    <title>Aluminum Blanking Co.- Coil Receiving Test</title>
</head>
<body>
    <p>
        <FORM id="coil_input" ACTION="coil_receiving_test.pl" METHOD="post">
...
ENDOFTEXT
                ...
                print <<ENDOFTEXT;
        <FORM id="coil_org_num" ACTION="coil_receiving_test.pl" METHOD="post">
                        </p>
                        <P>
ENDOFTEXT
...
ENDOFTEXT
                print <<ENDOFTEXT;
        <FORM id="coil_abc_num" ACTION="coil_receiving_test.pl" METHOD="post">
                        </p>
                        <P>
ENDOFTEXT
...
print <<ENDOFTEXT;
                ...
                <FORM ACTION="coil_receiving_test.pl" METHOD="post">
                        </p> 
                        <p>
