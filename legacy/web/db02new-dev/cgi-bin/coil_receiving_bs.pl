...
<body>
    <p>
        <FORM id="coil_input" ACTION="coil_receiving_bs.pl" METHOD="post">
...
ENDOFTEXT
		...
		print <<ENDOFTEXT;
        <FORM id="coil_org_num" ACTION="coil_receiving_bs.pl" METHOD="post">
 		 	</p>
		 	<P>
ENDOFTEXT
...
ENDOFTEXT
		print <<ENDOFTEXT;
        <FORM id="coil_abc_num" ACTION="coil_receiving_bs.pl" METHOD="post">
 		 	</p>
		 	<P>
ENDOFTEXT
...
print <<ENDOFTEXT;
		<FORM ACTION="coil_receiving_bs.pl" METHOD="post"> 		
...
ENDOFTEXT
        print '<INPUT type="hidden" NAME="2Dscan" VALUE="'.$coil_org_num.'">';
        print <<ENDOFTEXT;
		<p>
...
#<body>
#    <p>
#        <FORM id="defect_input" ACTION="coil_receiving_bs.pl" METHOD="post">
# 		<b>Scan 2D Defect Barcode: </b> 
#		 	</p>
#		 	<P>
#		 	<INPUT type="password" id="2D_Data" NAME="2D_Scanned_Data" VALUE="">
#		 	</p>
#		 	<P>
#		 	&nbsp;
#		 	</p>
#		 	<P>
#		 		<INPUT TYPE="submit" VALUE="Save Defects"> <br><br>
#		 	</p>
# 		</FORM>
 		
# 		<script type="text/javascript">
#  			document.getElementById("2D_Data").focus();
#		</script>
#    </p>
#</body>
#</html>
...
sub send_2Dscan ($) {
	my $coil_org_num = $_[0];
	my $coil_abc_num = '1234567890';
	$ENV{ORACLE_HOME} = '/apps/oracle/product/9.2.0.1.0';
	$dbh = DBI->connect( $db, $username . '/' . $passwd )
	  || error_report("Error connecting to database\n");

	  $dbh->do("UPDATE INBOUND_COIL 
				SET BARCODE_STRING = $coil_abc_num 
				WHERE COIL_NUMBER = '$coil_org_num'");
	  $dbh->do("COMMIT");
